...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        print('1111xxxxxxxxxxxxxxxxx', training_args)
    ...
    print('111111111111111111111111',training_args.do_eval)
    ...
    # Training
    print('3333333333333333', last_checkpoint)
    print('4444444444444444', training_args.resume_from_checkpoint)
    if training_args.do_train:
        checkpoint = None
